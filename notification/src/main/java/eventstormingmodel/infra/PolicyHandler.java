...
public class PolicyHandler {
    ...
    public void wheneverVideoProcessed_VideoProcessedPolicy(
        @Payload VideoProcessed videoProcessed
    ) {
        VideoProcessed event = videoProcessed;
        System.out.println(
            "\n\n##### listener VideoProcessedPolicy : " +
            videoProcessed +
            "\n\n"
        );
        // Sample Logic //
    ...
    public void wheneverFileUploaded_VideoProcessedPolicy(
        @Payload FileUploaded fileUploaded
    ) {
        FileUploaded event = fileUploaded;
        System.out.println(
            "\n\n##### listener VideoProcessedPolicy : " + fileUploaded + "\n\n"
        );
        // Sample Logic //
